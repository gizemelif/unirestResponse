...
public class Main {
    public static void main(String[] args) throws IOException{
        ...
        String filePath = "C:\\Users\\geatalay\\Desktop\\Vergi_numarasi_kontrol\\data_ankara.json";
       ...
       // JSONObject citiesArr = new JSONObject(iller);
        ...
        for(int i=0; i<jsonArray.length(); i++) {
           ...
           /* String plaka = "";
            ...
            String taxApt = new String(Files.readAllBytes(Paths.get("C:\\Users\\geatalay\\Desktop\\Vergi_numarasi_kontrol\\vergiDaireleri")), StandardCharsets.UTF_8);
    ...
    public static void writeFile(String str){
        File fileName = new File("C:\\Users\\geatalay\\Desktop\\Vergi_numarasi_kontrol\\ankara.txt");
        try {
